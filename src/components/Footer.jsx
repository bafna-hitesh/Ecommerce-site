    ...
    <div className='footer-container'>
        ...
        <ul class="footer-social-icons">
            <li class="list-inline-item">
                <a class="link-no-style footer-links" href="https://github.com/hiteshjain27">
                    <i class="fab fa-github"></i>
                </a>
            </li>
            <li class="list-inline-item ">
                <a class="link-no-style footer-links" href="https://twitter.com/hitesh_jain27">
                    <i class="fab fa-twitter"></i>
                </a>
            </li>
            <li class="list-inline-item">
                <a class="link-no-style footer-links" href="https://www.linkedin.com/in/bafna-hitesh/">
