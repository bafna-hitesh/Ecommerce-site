    ...
    <div className='cart-section'>
         <div className='cart-item'>
            <figure className='cart-item-figure'>
               <img className='cart-image' alt='' src='https://images.unsplash.com/photo-1560769629-975ec94e6a86?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8c2hvZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60' />
            </figure>
            <div className='cart-item-details'>
               <div className='cart-item-title'>Lorem ipsum dolor sit amet consectetur adipisicing.</div>
